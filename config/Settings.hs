...
-- declared in the BioSpace.hs file.
module Settings
    ( hamletFile
    , cassiusFile
    , juliusFile
...
approot = "http://newsite.genspace.org"
#else
...
--
-- If you change the resource pattern for StaticR in BioSpace.hs, you will
-- have to make a corresponding change here.
--
-- To see how this value is used, see urlRenderOverride in BioSpace.hs
staticroot :: Text
